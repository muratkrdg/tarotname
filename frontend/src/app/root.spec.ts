...
describe('App', () => {
  ...
  it('should have an url', inject([App], (app:App) => {
    expect(app.url).toEqual('//www.tarotname.com/');
  }));
  ...
  describe('subcomponents', function() {
    ...
    require('./components/contact/spec');
    require('./components/howitworks/spec');
    require('./components/media/spec');
    require('./components/products/spec');
    require('./components/sibyls/spec');
  })
